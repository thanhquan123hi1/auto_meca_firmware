...
void forwardLeft() {
  driveMecanum(MOTOR_STOP, MOTOR_FORWARD, MOTOR_FORWARD, MOTOR_STOP, MOTOR_SPEED_DEFAULT);
}

void forwardRight() {
  driveMecanum(MOTOR_FORWARD, MOTOR_STOP, MOTOR_STOP, MOTOR_FORWARD, MOTOR_SPEED_DEFAULT);
}
